...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        try {
            const userId = Date.now().toString(); // Mock unique user ID
            ...
            const payload = {
                ...
                phone: data.phone,
                email: data.email,
                permAddress: data.address,
                password:data.password,
                sellerRole: data.userType === "individual" ? "INDIVIDUAL" : "ORGANISATION",
            ...
            console.log("User saved to localStorage:", payload);

            // Register dealer (optional, if API needed)
                        ...
                        <div className="card-body">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="form-control w-full">
                                    ...
                                    <input {...register("password", { required: "Password is required" })} placeholder='Password should be of max 6 ' type="password" className="input input-bordered w-full bg-white" />
                                </div>
                            </div>
